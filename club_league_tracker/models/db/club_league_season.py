...
class club_league_season(db.Model):
    ...
    start_members = db.Column('season_start_members', db.Integer, nullable=True, default=DEFAULTS.INTEGER)
    end_members = db.Column('season_end_members', db.Integer, nullable=True, default=DEFAULTS.INTEGER)
    day_one_trophies = db.Column('season_day_one_trophies', db.Integer, nullable=False, default=DEFAULTS.INTEGER)
    day_two_trophies = db.Column('season_day_two_trophies', db.Integer, nullable=False, default=DEFAULTS.INTEGER)
    day_three_trophies = db.Column('season_day_three_trophies', db.Integer, nullable=False, default=DEFAULTS.INTEGER)
    total_trophies = db.Column('season_total_trophies', db.Integer, nullable=False, default=DEFAULTS.INTEGER)
    participation = db.Column('season_participation', db.Integer, nullable=True, default=DEFAULTS.INTEGER)
